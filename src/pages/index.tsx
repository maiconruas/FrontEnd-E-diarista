...
import {FormElementsContainer, ProfissionalContainer, ProfissionalPapper} from "@styles/pages/index.style";
      ...
      <SafeEnvironment />
        ...
        <Container>
            <FormElementsContainer>
                ...
                <Button variant={'contained'} color={'secondary'} sx={{ width: '220px'}} disabled={!cepValido || carregando} onClick={() => buscarProfissionais(cep)}>
